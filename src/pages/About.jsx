      ...
      <div className="row text-center mt-5">
        {[
          ...
          },
          {
            ...
            img: "src/assets/img/icon_chart-mixed-up-circle-dollar.png",
          },
          {
            count: "45.5k",
            text: "Customers active on our site",
            img: "src/assets/img/icon_shopping-cart.png",
          },
          {
            count: "25k",
            text: "Annual gross sales on our site",
            img: "src/assets/img/icon_sack-dollar.png",
          },
        ].map((item, index) => (
          <div key={index} className="col-md-3 mb-3">
            <div className="card p-4 shadow border hover-shadow">
              <div
                className="bg-light p-3 rounded-circle mx-auto d-flex align-items-center justify-content-center"
